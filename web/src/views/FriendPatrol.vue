...
<template>
  <div class="friend-patrol-page">
    ...
    <!-- Help Info -->
    <div class="mt-6 rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-900/50 dark:bg-blue-900/20">
      <h4 class="mb-2 flex items-center gap-2 text-sm text-blue-900 font-medium dark:text-blue-100">
